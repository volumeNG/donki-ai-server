            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                <tr>
                    <td style="text-align: center;">
                        <img src="${config_1.default.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px;"> <br>
          ...
          <div class="container">
              <div class="email-box">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                      <tr>
                          <td style="text-align: center;">
                              <img src="${config_1.default.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px;"> 
                              <!-- <h3 style="display: inline; margin: 0; padding-left: 10px;"> Wealth Promiseland</h3> -->
                          </td>
                      </tr>
                  </table>
